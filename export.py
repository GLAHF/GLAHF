...
class InfoDialog(QtGui.QDialog):
    ...
    def __init__(self, parent = None):
        ...
        self.hospitalized_label.setText(_translate('MainWindow', '\xe4\xbd\x8f\xe9\x99\xa2\xe5\x8f\xb7', None))
        ...
        self.outpatient_label.setText(_translate('MainWindow', '\xe9\x97\xa8\xe8\xaf\x8a\xe5\x8f\xb7', None))
        ...
        self.datetime_label.setText(_translate('MainWindow', '\xe6\xa3\x80\xe6\xb5\x8b\xe6\x97\xb6\xe9\x97\xb4', None))
        ...
        self.name_label.setText(_translate('MainWindow', '\xe5\xa7\x93\xe5\x90\x8d', None))
        self.name = QtGui.QLineEdit(self)
        layout.addWidget(self.name_label, 1, 0, 1, 1)
        layout.addWidget(self.name, 1, 1, 1, 1)
        self.sex_label = QtGui.QLabel(self)
        self.sex_label.setText(_translate('MainWindow', '\xe6\x80\xa7\xe5\x88\xab', None))
        ...
        self.marriage_label.setText(_translate('MainWindow', '\xe5\xa9\x9a\xe5\xa7\xbb', None))
        ...
        self.born_label.setText(_translate('MainWindow', '\xe5\x87\xba\xe7\x94\x9f\xe5\xb9\xb4\xe6\x9c\x88', None))
        ...
        self.height_label.setText(_translate('MainWindow', '\xe8\xba\xab\xe9\xab\x98', None))
        self.height = QtGui.QComboBox()
        self.height.addItems([ '%scm' % i for i in xrange(50, 200) ])
        layout.addWidget(self.height_label, 2, 2, 1, 1)
        layout.addWidget(self.height, 2, 3, 1, 1)
        self.weight_label = QtGui.QLabel(self)
        self.weight_label.setText(_translate('MainWindow', '\xe4\xbd\x93\xe9\x87\x8d', None))
        self.weight = QtGui.QComboBox()
        self.weight.addItems([ '%skg' % i for i in xrange(20, 200) ])
        ...
        self.chief_complaint_label.setText(_translate('MainWindow', '\xe4\xb8\xbb\xe8\xaf\x89', None))
        ...
        self.diagnose_label.setText(_translate('MainWindow', '\xe5\x88\x9d\xe6\xad\xa5\xe8\xaf\x8a\xe6\x96\xad', None))
